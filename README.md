...
<div align="center">
  <img src="img/data_distribution.png" alt="Data Distribution" width="400">
...
<div align="center">
  <img src="img/data_creation.png" alt="Data Creation" width="850">
...
- **Breaking high- and low-resource cross-lingual barriers**: CroFinBen is the first benchmark supporting cross-mainstream and low-resource finance, particularly SEA languages (Ind, Tha, Fil, Vie, and May), filling the gap in low-resource financial tasks.
...
|--------------|----------------|--------|--------|--------|----------|--------|--------|----------|--------|--------|---------|
|              | FinSA            | FinSP     | FinTS    | FinTC      | CLS      | GEN    | REA    | Eno       | Zho     | SEA    |         |
...
| DeepSeek-LLM     | 0.333          | 0.303  | 0.245  | 0.348  | 0.340    | 0.245  | 0.303  | 0.420    | 0.226  | 0.275  | 0.307   |
