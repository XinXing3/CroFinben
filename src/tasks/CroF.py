...
#FinSA
class FETask(Classification):
    DATASET_PATH = "../data/FE"
class FpbTask(Classification):
    DATASET_PATH = "../data/fpb"
class FinSentTask(Classification):
    DATASET_PATH = "../data/FinSent"
class MayFPBTask(Classification):
    DATASET_PATH = "../data/MayFPB"



#FinTC
class NLTask(Classification):
    DATASET_PATH = "../data/NL"
class Headlines(Classification):
    DATASET_PATH = "../data/Headlines"
class AppRevsTask(Classification):
    DATASET_PATH = "../data/AppRevs"
class VieNLTask(Classification):
    DATASET_PATH = "../data/VieNL"
...
class EDTSUM(AbstractiveSummarization):
    DATASET_PATH = "../data/english/edtsum"
class NATask(AbstractiveSummarization):
    DATASET_PATH = "../data/NA"
class ThaNATask(AbstractiveSummarization):
    DATASET_PATH = "../data/english/ThaNA"
...
class StockATask(StockMovement):
    DATASET_PATH = "../data/stockA"
class ACL18Task(StockMovement):
    DATASET_PATH = "../data/ACL18"
class StockIndCIKM18(StockMovement):
    DATASET_PATH = "../data/cikm"
class StockMovementACLFil(StockMovement):
    DATASET_PATH = "../data/filacl"


SM_TASKS = {

    "flare__sm_aclFil": StockMovementACLFil,
