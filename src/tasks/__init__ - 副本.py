...
TASK_REGISTRY = {
     "flare_finredVi": flare.FinREDVi,
     "flare_ThGerman": flare.ThGermanTask,
    "flare_thEx": flare.ThExTask,
    "flare_IdFincl": flare.IDFincl,
    ...
    "flare_viFincl": flare.viFinclTask,
    "flare_NL": flare.NLTask,
    ...
    "flare_sm_aclTH": flare.StockMovementACLTH,
    "flare_finredVi": flare.FinREDVi,
    "flare_stockATh": flare.StockMovementStockA,
    "flare_fiqasa": flare.FIQASA,
    "flare_cra_lendingclub": flare.lendingclub,
    "flare_headlines": flare.PHHeadlines,
    "flare_finevalF": flare.finevalF,

    "zhongwen_test": flare.ZHTEST,

    "flare_ThcomputerPart":flare.ThcomputerPart,
    "flare_IndcomputerPart":flare.IndcomputerPart,
    "flare_FilComputerPart":flare.FilComputerPart,
    "flare_MayComputerPart":flare.MayComputerPart,
    "flare_VieComputerPart":flare.VieComputerPart,

    #"flare_finURLsumId": flare.FinURLSumIdTask,
    "flare_na": flare.FinNATask,
...
'''
 "flare_IDFinTextSum": flare.IDFinTextSumTask,
    "flare_IDFinURLSum": flare.IDFinURLSumTask,
...
TASK_REGISTRY = {
    ...
    "flare_finevalF": flare.finevalF,
    "flare_na": flare.NA,
    "flare_stockA": flare.stockA,
    "flare_th_acl": flare.ThACl,
    "flare_th_ex": flare.ThEx,
    ...
    "flare_xuanyuan": flare.ZHxuanyuan,
    "flare_disc": flare.ZHdisc,
    "flare_company": flare.ZHcompany,
    "flare_product": flare.ZHproduct,
    "flare_sentiment": flare.ZHsentiment,
    "flare_suggestion": flare.ZHsuggestion,
    **flare.SM_TASKS,
}
